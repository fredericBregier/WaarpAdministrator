...
public class AdminR66OperationsGui extends JFrame {
  ...
  private void initializePanel() {
    ...
    scrollPane.setViewportBorder(
        new SoftBevelBorder(BevelBorder.LOWERED, null, null, null,
                            null));
  ...
  private void initBandwidth(JTabbedPane tabbedPane) {
    ...
    {
      JLabel lblGlobalLimit = new JLabel(
    ...
    {
      JLabel lblSessionLimit = new JLabel(
    ...
    }
    {
      ...
      GridBagConstraints gbc_btnSetBandwidthConfiguration =
    ...
    btnHostsFile.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        File result = openFile(
            ...
            Messages.getString("AdminR66OperationsGui.22"),
            "xml"); //$NON-NLS-1$
        if (result != null) {
    ...
    btnRulesFile.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        File result = openFile(
            ...
            Messages.getString("AdminR66OperationsGui.Choose") +
            Messages.getString("AdminR66OperationsGui.25"),
            "xml"); //$NON-NLS-1$
        if (result != null) {
      ...
      btnBusinessFile.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          File result = openFile(
              ...
              Messages.getString("AdminR66OperationsGui.Choose") +
              Messages.getString("AdminR66OperationsGui.28"),
              "xml"); //$NON-NLS-1$
          if (result != null) {
      ...
      btnAliasFile.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          File result = openFile(
              ...
              Messages.getString("AdminR66OperationsGui.Choose") +
              Messages.getString("AdminR66OperationsGui.31"),
              "xml"); //$NON-NLS-1$
          if (result != null) {
      ...
      btnRolesFile.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          File result = openFile(
              ...
              Messages.getString("AdminR66OperationsGui.Choose") +
              Messages.getString("AdminR66OperationsGui.34"),
              "xml"); //$NON-NLS-1$
          if (result != null) {
    ...
    if (future.isSuccess()) {
      ...
      if (useJson) {
        ...
        if (packet != null) {
          ...
          ConfigExportResponseJsonPacket node =
          ...
          if (message.length() > 1) {
            ...
            if (getHost && shost != null && !shost.isEmpty()) {
              ...
              DirectTransfer transfer = new DirectTransfer(
                  ...
                  Messages.getString("AdminR66OperationsGui.GetConfig")
                  //$NON-NLS-1$
            ...
            if (getBusiness && sbusiness != null && !sbusiness.isEmpty()) {
              ...
              if (future.isSuccess()) {
                ...
                message +=
                    Messages.getString("AdminR66OperationsGui.Business") +
                    Messages.getString("AdminR66OperationsGui.FileInto") +
                    sbusiness +
                    "\n"; //$NON-NLS-1$
              } else {
                getBusiness = false;
    ...
    if (hostfile != null && hostfile.length() > 1) {
      ...
      if (!future.isSuccess()) {
        ...
        msg += " " + Messages.getString("AdminR66OperationsGui.Hosts") +
               Messages.getString(
                   "AdminR66OperationsGui.ConfigTransmitted"); //$NON-NLS-1$
  ...
  public void exportLog() {
    ...
    logger.debug("UseJson: " + useJson); //$NON-NLS-1$
    if (useJson) {
      LogExtendedExport export =
          new LogExtendedExport(future, clean, purgeLog, start,
    ...
    if (future.isSuccess()) {
        ...
        if (fileExported != null && !fileExported.isEmpty()) {
          ...
          if (ruleToExport == null || ruleToExport.isEmpty()) {
            message =
                ...
                Messages.getString(
                    "AdminR66OperationsGui.171"); //$NON-NLS-1$ //$NON-NLS-2$
          } else {
            future = new R66Future(true);
            DirectTransfer transfer =
                new DirectTransfer(future, host.getHostid(),
                                   fileExported,
                                   ruleToExport,
                                   Messages
                                       .getString("AdminR66OperationsGui.172")
                                   //$NON-NLS-1$
                                   + AdminGui.getEnvironnement().hostId,
                                   AdminGui.getEnvironnement().isMD5,
                                   Configuration.configuration.getBLOCKSIZE(),
            ...
            if (!future.isSuccess()) {
              message =
                  Messages.getString("AdminR66OperationsGui.170") +
                  fileExported + "\n"; //$NON-NLS-1$
            } else {
      ...
      if (result.getCode() == ErrorCode.Warning) {
        message += Messages.getString(
            "AdminR66OperationsGui.175",
            Messages.getString("RequestInformation.Warned")) +
                   future.getCause(); //$NON-NLS-1$
      } else {
        message += Messages.getString(
            "AdminR66OperationsGui.175",
  ...
  public void shutdown() {
    ...
    try {
      ...
      message =
          Messages.getString("AdminR66OperationsGui.187") +
    ...
    localChannelReference.getFutureRequest()
                         .awaitUninterruptibly(180, TimeUnit.SECONDS);
